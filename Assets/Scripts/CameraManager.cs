...
public class CameraManager : MonoBehaviour {
	...
	void Update () {
        ...
        //This switches the cameras automatically whenever the final cam position is reached
        //if (currentTimeFactor >= 1.0f)
        //This let's the user press a button to switch the camera
        if(Input.anyKeyDown)
        {
